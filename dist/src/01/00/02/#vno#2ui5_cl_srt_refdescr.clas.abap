...
CLASS /vno/2ui5_cl_srt_refdescr DEFINITION
  PUBLIC
  INHERITING FROM /vno/2ui5_cl_srt_datadescr
  CREATE PUBLIC.

  PUBLIC SECTION.

    DATA referenced_type TYPE REF TO /vno/2ui5_cl_srt_typedescr.
...
CLASS /vno/2ui5_cl_srt_refdescr IMPLEMENTATION.
  METHOD constructor.
    super->constructor( rtti ).
    CREATE OBJECT referenced_type TYPE /vno/2ui5_cl_srt_typedescr
