CLASS /vno/2ui5_cl_http_handler DEFINITION
  ...
  PROTECTED SECTION.
    ...
    DATA mo_server TYPE REF TO /vno/2ui5_cl_util_abap_http.
...
CLASS /vno/2ui5_cl_http_handler IMPLEMENTATION.
  ...
  METHOD factory.
    ...
    IF server IS BOUND.
      result->mo_server = /vno/2ui5_cl_util_abap_http=>factory( server ).
  ...
  METHOD factory_cloud.
    ...
    result = NEW #( ).
    result->mo_server = /vno/2ui5_cl_util_abap_http=>factory_cloud( req = req
                                                               res  = res ).
